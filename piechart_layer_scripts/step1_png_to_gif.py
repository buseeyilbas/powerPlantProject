...
PNG_FOLDER = Path(
    r"C:\Users\jo73vure\Desktop\powerPlantProject\exports\1_state_pie_yearly\germany_statePie_yearly"
)
...
if FRAME_DURATION_MS == 1000:
    ...
    # Output GIF file
    OUTPUT_GIF = OUTPUT_FOLDER_1 / "state_piecharts_gif_1s.gif"

elif FRAME_DURATION_MS == 2000:
    print("[INFO] Frame duration set to 2 seconds per frame.")
    # Output GIF file
    OUTPUT_GIF = OUTPUT_FOLDER_2 / "state_piecharts_gif_2s.gif"
