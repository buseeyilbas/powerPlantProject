...
# ---------- PATHS ----------
INPUT_ROOT = Path(r"D:\FAU_HiWi\powerPlantProject\data\geojson\by_state_yearly_4_checks")
OUT_BASE = Path(r"D:\FAU_HiWi\powerPlantProject\data\geojson\pieCharts\state_pies_yearly")
BASE_FIXED = Path(r"D:\FAU_HiWi\powerPlantProject\data\geojson\pieCharts\state_pies")
GLOBAL_META = OUT_BASE / "_GLOBAL_style_meta.json"
...
PIE_LEGEND_VALUES_GW = [5, 10, 15, 20]
PIE_LEGEND_CENTER_LON = 4.0
PIE_LEGEND_TOP_LAT = 54.8
PIE_LEGEND_LABEL_DX_DEG = 0.8
...
LEG_TOP_LAT = 54.9
LEG_ROW_STEP = -0.24
LEGEND_TITLE_LAT = PIE_LEGEND_TITLE_LAT
...
def write_pie_size_legend(global_min_kw, global_max_kw):
    ...
    label_rows.append({
        ...
        "geometry": Point(PIE_LEGEND_CENTER_LON + 0.15, PIE_LEGEND_TITLE_LAT),
    })
...
def main():
    ...
    if global_totals:
        ...
        legend_feats.append({
            ...
            "geometry": Point(LEG_BASE_LON - 0.1, LEGEND_TITLE_LAT),
        })
