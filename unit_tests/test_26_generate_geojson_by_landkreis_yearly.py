"""
Unit tests for step26_generate_geojson_by_landkreis_yearly.py
"""
...
from scripts import step26_generate_geojson_by_landkreis_yearly as mod
...
def test_load_gadm_l2_polygons(sample_gadm_l2_geojson):
    ...
    assert polygons[1][0] == "Landkreis B"
...
def test_convert_landkreis_yearly_end_to_end(
    temp_workspace,
    ...
    mod.convert_landkreis_yearly()

    a_2020 = output_dir / "Landkreis A" / "2020.geojson"
    a_2021 = output_dir / "Landkreis A" / "2021.geojson"
    b_unknown = output_dir / "Landkreis B" / "unknown.geojson"
...
def test_convert_landkreis_yearly_empty_input(
    temp_workspace,
    sample_state_geojson,
    sample_gadm_l2_geojson,
    monkeypatch,
    ...
    assert list(output_dir.rglob("*.geojson")) == []


def test_convert_landkreis_yearly_with_empty_l2_produces_no_outputs(
    temp_workspace,
    sample_state_geojson,
    monkeypatch,
):
