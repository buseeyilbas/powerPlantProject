# Filename: 6_save_current_view_png_svg_2_thuringen_statewise_landkreis_pie_yearly.py
...
# ---- SETTINGS ----
OUT_DIR = Path(r"C:\Users\jo73vure\Desktop\powerPlantProject\exports\2_statewise_landkreis_pie_yearly\thuringen_statewiseLandkreisPie_yearly_masked")  # change if needed
BASE_FILENAME = "maStr_pieChart_Thueringen_statewiseLandkreisPies"  # <-- put your desired base filename here (no extension)
DPI = 1000
SCALE = 10
