...
# Purpose:
#   Nationwide Landkreis yearly piecharts (polygon pies) + row/column charts + legends
#   Fully aligned with 2_style_statewise_landkreisPieChart_yearly.py
#
# Covered:
...
# Legends + frames (produced by step3_3)
