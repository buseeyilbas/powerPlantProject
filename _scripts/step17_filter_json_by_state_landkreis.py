...
# ========== CONFIG ==========
INPUT_FOLDER = r"C:\Users\jo73vure\Desktop\powerPlantProject\data\filtered_json_by_state_4checks" # by filtering 4-checked data, we ensure consistency. this is already filtered using active json
