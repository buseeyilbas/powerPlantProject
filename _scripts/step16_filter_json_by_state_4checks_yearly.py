...
4 CHECKS:
  1) polygon state match
  2) Bundesland code match
  3) Gemeindeschluessel prefix match
...
OUTPUT_ROOT  = r"C:\Users\jo73vure\Desktop\powerPlantProject\data\filtered_json_by_state_yearly_4checks"
POLYGON_STATES_PATH = r"C:\Users\jo73vure\Desktop\powerPlantProject\data\polygon_states.json"  # features[].properties.name

# NEW (4th check): Landkreis polygons
...
# ---------- NEW (4th check): Landkreis polygons (Step17-style) ----------
...
def filter_json_by_state_year_four_checks(
    input_folder: str,
    output_root: str,
...
if __name__ == "__main__":
    filter_json_by_state_year_four_checks(
        INPUT_FOLDER,
        OUTPUT_ROOT,
        POLYGON_STATES_PATH,
        GADM_L2_PATH,
